    ...
    let eventsData = [
        { id: 11, name: "Himas", platform: "T1Ran", organizer: "Нет", date: "10.04, 13:25 - 20.20 - 20.30", status: "Проведен", rating: "10.000$", members: 8, callStatus: "🟡Скоро", fullDetails: { description: "Игроки бьются на кулаках в ринге кто побеждает получает 10.000", tasks: "", feedback: "", rewards: "", extra:"" } },
        ...
        { id: 9, name: "Смертельные собаки", platform: "T1Ran", organizer: "Нет", date: "12.04, 13:25 - 8:50-9:00", status: "Проведен", rating: "10.000$", members: 10, callStatus: "🟡Скоро", fullDetails: { description: "Три собаки и игроки должны от них убегать кто выживет получит 10.000$", tasks: "", feedback: "", rewards: "", extra:"" } },
